...
{ 
    ...
    wc.lpszClassName = _T("OGL3DWindow");
    ...
    m_handle = CreateWindowEx(NULL, MAKEINTATOM(classId), _T("Baptiste | OpenGL 3D Game"), WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT,
